...
set(mavlink_DIALECTS ASLUAV;ardupilotmega;autoquad;common;matrixpilot;paparazzi;slugs;standard;uAvionix;ualberta)
set(mavlink2_DIALECTS ASLUAV;ardupilotmega;autoquad;common;matrixpilot;paparazzi;slugs;standard;uAvionix;ualberta)

foreach(lib )
  set(onelib "${lib}-NOTFOUND")
  find_library(onelib ${lib}
      PATHS "/home/jack/ME580/catkin_ws/devel/lib"
    NO_DEFAULT_PATH
    )
  if(NOT onelib)
