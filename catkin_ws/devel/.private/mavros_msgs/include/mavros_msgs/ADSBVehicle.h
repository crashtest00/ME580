...
struct ADSBVehicle_
{
  ...
  _squawk_type squawk;
    ...
    enum { ALT_PRESSURE_QNH = 0u };
     enum { ALT_GEOMETRIC = 1u };
     enum { EMITTER_NO_INFO = 0u };
     enum { EMITTER_LIGHT = 1u };
     enum { EMITTER_SMALL = 2u };
     enum { EMITTER_LARGE = 3u };
     enum { EMITTER_HIGH_VORTEX_LARGE = 4u };
     enum { EMITTER_HEAVY = 5u };
     enum { EMITTER_HIGHLY_MANUV = 6u };
     enum { EMITTER_ROTOCRAFT = 7u };
     enum { EMITTER_UNASSIGNED = 8u };
     enum { EMITTER_GLIDER = 9u };
     enum { EMITTER_LIGHTER_AIR = 10u };
     enum { EMITTER_PARACHUTE = 11u };
     enum { EMITTER_ULTRA_LIGHT = 12u };
     enum { EMITTER_UNASSIGNED2 = 13u };
     enum { EMITTER_UAV = 14u };
     enum { EMITTER_SPACE = 15u };
     enum { EMITTER_UNASSGINED3 = 16u };
     enum { EMITTER_EMERGENCY_SURFACE = 17u };
     enum { EMITTER_SERVICE_SURFACE = 18u };
     enum { EMITTER_POINT_OBSTACLE = 19u };
     enum { FLAG_VALID_COORDS = 1u };
     enum { FLAG_VALID_ALTITUDE = 2u };
     enum { FLAG_VALID_HEADING = 4u };
     enum { FLAG_VALID_VELOCITY = 8u };
     enum { FLAG_VALID_CALLSIGN = 16u };
     enum { FLAG_VALID_SQUAWK = 32u };
     enum { FLAG_SIMULATED = 64u };
...
// {'geographic_msgs': ['/opt/ros/kinetic/share/geographic_msgs/cmake/../msg'], 'sensor_msgs': ['/opt/ros/kinetic/share/sensor_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'mavros_msgs': ['/home/jack/ME580/catkin_ws/src/mavros/mavros_msgs/msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'uuid_msgs': ['/opt/ros/kinetic/share/uuid_msgs/cmake/../msg']}
